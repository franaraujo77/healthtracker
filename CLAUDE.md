...
- **Deferred to later Epic 9 stories:** stub-era `failed` re-enqueue (9.4). Sync `AnalyzeDocument` `Bytes` is single-page / ≤10 MB; multi-page async `StartDocumentAnalysis` is a future story.
